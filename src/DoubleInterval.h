...
public:
	...
	std::string toMathematicaString() const;
  std::string midToString() const;
	std::string getLower(int prec) const;
	std::string getHigher(int prec) const;
	std::string getLower() const;
	std::string getHigher() const;
...
bool subseteq(const std::vector<Interval> & I1, const std::vector<Interval> & I2);
