...
public:
	...
	void insert_normal(TaylorModel & result, const TaylorModelVec & vars, const vector<Interval> & varsPolyRange, const vector<Interval> & step_exp_table, const int numVars, const Interval & cutoff_threshold) const;
	...
	void insert_no_remainder_no_cutoff(Polynomial & result, const vector<Polynomial> & vars, const int numVars) const;
	...
	void insert_ctrunc_normal(TaylorModel & result, RangeTree * & tree, const TaylorModelVec & vars, const vector<Interval> & varsPolyRange, const vector<Interval> & step_exp_table, const int numVars, const int order, const Interval & cutoff_threshold) const;	// the first time
  ...
  HornerForm transform(map<int, int> lookup, int size) const;
...
public:
	...
	void cutoff_normal(Interval & intRem, const vector<Interval> & step_exp_table, const Interval & cutoff_threshold);
	void cutoff(Interval & intRem, const vector<Interval> & domain, const Interval & cutoff_threshold);
