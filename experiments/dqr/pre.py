...
modelTypes = ["moore_rot", "and_fast_out_high", "and_fast_out_low", "and_lin", "and_nl", "test", "bouncing_ball", "Brusselator", "moore_rot", "buckling_column", "cruise_control", "diabetic_1", "diabetic_2", "filtered_oscillator_4", "filtered_oscillator_8", "filtered_oscillator_16", "jet_engine", "Lorentz", "Lotka_Volterra", "moore_rot_point", "neuron_I", "neuron_II", "Roessler", "rod_reactor", "switching_5", "two_tanks", "vanderpol", "vehicle_platoon_3", "lin", "lin_dep", "pair_dep", "sq_deg_long"]


modelTypes2 = ["Lotka_Volterra", "switching_5", "and_fast_out_high"]

algos = ["qrplain", "id", "none"]
algos2 = ["none"]
dims = ["nodim"]
