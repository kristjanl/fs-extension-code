...
pairs = []
pairs = pairs + [('moore_rot_plain.model', 'moore_rot_QR.model')]
pairs = pairs + [('moore_rot_point_plain.model', 'moore_rot_point_QR.model')]
pairs = pairs + [('Brusselator_plain.model', 'Brusselator_QR.model')]




tf.generate_comparision_plots(scriptsDir, modelDir, pairs, "_plain_QR")

tf.write_table("experiments_plain_QR.html", modelDir, pairs, "_plain_QR")
