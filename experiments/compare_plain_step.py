...
pairs = pairs + [('moore_rot_point_plain.model', 'moore_rot_point_sw_10.model')]
...
tf.generate_comparision_plots(scriptsDir, modelDir, pairs, "_plain_step")

tf.write_table("experiments_plain_step.html", modelDir, pairs, "_plain_step")
